...
class PublicUserApiTests(TestCase):
    ...
    def test_create_tokent_for_user(self):
        """Test generate token for valid crednetials."""
        user_details = {
            'name': "Test User",
            'email': 'test@example.com',
            'password': 'pass@123',
    ...
    def test_create_token_bad_credentials(self):
        ...
        create_user(email='test@example.com', password='pass@123')

        pay_load = {'email': 'test@example.com','password': 'wrongpass'}
        res = self.client.post(TOKEN_URL, pay_load)
    ...
    def test_retrieve_user_unauthorize_(self):
...
class PrivateUserApiTests(TestCase):
    """Test API rquest that required authentication"""
    ...
    def test_update_user_profile(self):
        ...
        payload = {'name': 'Updated name', 'password':'newpass@123'}
